-- ---------------------------------------------------------------------------
-- 0071: Include member photo (avatar_url) in scan details
--
-- The attendance scanner and attendance admin show "who was marked present"
-- with full details (name, ID, department, rounds, etc.). Add the member's
-- photo so it can be shown alongside those details.
-- ---------------------------------------------------------------------------

-- ============================================================================
-- KL CIIE Platform V2 — 0024: friendly scanner messages
-- When an attendance QR belonging to another event is scanned (or a code that
-- is not registered for the current event), mark_attendance now reports the
-- attendee-friendly message instead of the technical "Event Mismatch". The
-- website scanner maps the EVTMIS errcode to this same popup text, and the DB
-- message stays consistent for any direct callers / logs.
-- ============================================================================

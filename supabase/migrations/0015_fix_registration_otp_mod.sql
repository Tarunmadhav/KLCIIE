-- ---------------------------------------------------------------------------
-- FIX: "operator does not exist: bigint % double precision"
-- In migration 0008, registration_otp_at computed `v_bin % (34 ^ 6)` where
-- v_bin is bigint but `34 ^ 6` resolves to double precision in Postgres,
-- making the `%` operator unresolvable. Replace with the constant
-- 34^6 = 1544804416 (bigint) so the modulo works.
-- ---------------------------------------------------------------------------

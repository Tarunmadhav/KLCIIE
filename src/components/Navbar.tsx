...
import { Camera, ChevronDown, ClipboardCheck, Home, Info, LayoutDashboard, LogOut, Mail, Menu, MessageSquareText, Moon, Rocket, Shield, Sun, User, UserCheck, X, Zap } from 'lucide-react'
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/70 backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/70">
      ...
      {open && (
        <div className="max-h-[calc(100dvh-4rem)] overflow-y-auto border-t border-slate-200 bg-white px-4 py-3 md:hidden dark:border-slate-700 dark:bg-slate-900">
          <nav className="flex flex-col gap-1">
            ...
            <div className="mt-2 border-t border-slate-200 pt-2">
              <button
                onClick={() => { toggle() }}
                className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
              >
